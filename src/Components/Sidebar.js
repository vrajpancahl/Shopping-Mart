    ...
    return (
        <div className={(props.sidebar_show2 == true) ? 'sidebar-container' : 'sidebar-close'}>
            ...
            <div className='sidebar-button-container'>
                    ...
                    <div onClick={() => { navigate('/about_page') }} className="sidebar-tab-button contact-cursorpointer">
                        <p className='sidebar-button-p'><AiOutlineInfoCircle /></p>
                        <p className='sidebar-button-p'>About Us</p>
                    </div>
                    <div onClick={() => { navigate('/contact_page') }} className="sidebar-tab-button contact-cursorpointer">
                        <p className='sidebar-button-p'><IoMdContacts /></p>
                        <p className='sidebar-button-p'>Contact Us</p>
                    </div>
                    <div onClick={() => { logout("/") }} className="sidebar-tab-button contact-cursorpointer">
